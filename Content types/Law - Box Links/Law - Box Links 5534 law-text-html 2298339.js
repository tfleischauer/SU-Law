...
try {
  ...
  var link1Internal = com.terminalfour.publish.utils.BrokerUtils.processT4Tags(dbStatement, publishCache, section, content, language, isPreview, "<t4 type='content' name='Link 1 Internal' output='normal' modifiers='nav_sections' />");
  ...
  var link2Internal = com.terminalfour.publish.utils.BrokerUtils.processT4Tags(dbStatement, publishCache, section, content, language, isPreview, "<t4 type='content' name='Link 2 Internal' output='normal' modifiers='nav_sections' />");
  ...
  var link3Internal = com.terminalfour.publish.utils.BrokerUtils.processT4Tags(dbStatement, publishCache, section, content, language, isPreview, "<t4 type='content' name='Link 3 Internal' output='normal' modifiers='nav_sections' />");
   ...
   * 
   * */
  var BoxLinksWrapperOpen = '<div class="BoxLinksWrapper contentItem hspace" id="id' + contentID + '" data-position-default="Main" data-position-selected="Main" aria-labelledby="' + Heading + '">' + anchorTag + '';
